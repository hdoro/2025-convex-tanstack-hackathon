...
export type ThemeStyleProps = {
	...
	foreground: string
	/** The background color for cards, paired with `card-foreground`. */
	card: string
	/** Paired with `card`. */
	...
	/** The main color, paired with `primary-foreground`. */
	primary: string
	/** Paired with `primary`. */
	'primary-foreground': string
	/** A secondary color, paired with `secondary-foreground`. */
	secondary: string
	/** Paired with `secondary`. */
	'secondary-foreground': string
	/** A muted background color, paired with `muted-foreground`. */
	muted: string
	/** Paired with `muted`. */
	...
	/** Paired with `sidebar-primary`. */
	'sidebar-primary-foreground': string
	/** An accent color for the sidebar, paired with `sidebar-accent-foreground`. */
	'sidebar-accent': string
	/** Paired with `sidebar-accent`. */
	'sidebar-accent-foreground': string
	/** The color for borders within the sidebar. */
	'sidebar-border': string
	/** The color for focus rings within the sidebar. */
	'sidebar-ring': string
	/** Primary UI font. May be serif, sans, monospace, or display depending on the theme vibe. */
	'font-sans': string
	/** The preferred serif font family. */
	'font-serif': string
	/** The preferred monospace font family. Used for code blocks. */
	'font-mono': string
	...
	/** The global letter spacing for text. */
